...
<div class="fixed top-0 left-0 flex h-screen w-64 flex-col bg-white shadow-lg">
  ...
  <div class="p-3 flex flex-col flex-1 overflow-y-auto">
    ...
    <a href="users.php" class="flex items-center gap-3 rounded-lg px-3 py-2 mb-2 text-gray-700 hover:bg-gray-200">
      <i class="fas fa-users"></i> Users
    </a>

    <a href="settings.php" class="flex items-center gap-3 rounded-lg px-3 py-2 mb-2 text-gray-700 bg-green-200">
